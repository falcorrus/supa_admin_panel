      ...
      <div className="hidden lg:flex lg:w-1/2 relative items-center justify-center bg-gray-900 overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl px-12 text-left">
            ...
            <h2 className="text-5xl font-extrabold text-white leading-tight mb-6">
                Мощность Supabase <span className="text-emerald-400">для тебя</span>. <br/>
                Простота Excel <span className="text-emerald-400">для клиента</span>.
            </h2>
            
            <p className="text-xl text-gray-400 leading-relaxed max-w-lg">
                Интуитивный табличный интерфейс, который не нужно объяснять. 
                Сортировка, drag-and-drop и редактирование данных — без единой строчки кода с твоей стороны.
            </p>
        </div>
      </div>
